...
label test:
    ...
    scene bg semen_room with dissolve
    "Полунину стало интересно, о чем на этот раз идёт разговор, и он вышел за дверь и подошел к их двери почти вплотную."
    th "Всё равно спать не дают, хоть послушаю, что у них происходит."
