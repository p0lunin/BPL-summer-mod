...
label test:
    ...
    ps 'Да, зимние улицы красивые. Жаль, что когда есть какие-то дела помимо похода в магазин, то просто не обращаешь на это внимания. А ведь '+\
    'закончится мой "отпуск", и я вернусь к привычному образу жизни - учеба-дом-сон-учеба. А потом учёба заменится на работу, но глобально всё равно ничего не поменяется.'
    # звук удара
