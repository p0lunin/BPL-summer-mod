...
label vi_kto:
    ...
    u"Парень" "А МЫ ВООБЩЕ ГДЕ!?"
    br "Я сам не знаю, думал ты знаешь"
    u"Парень" "Как будто мы вчера очень хорошо набухались... Надо вспомнить, что было до этого."
    "Они начали вспоминать."
    u"Парень" "Я, кажется, вспомнил! Меня сбила машина по дороге в магазин..."
    "Он ощупал себя"
    u"Парень" "Но как? Я вроде цел, даже не сломано ничего."
    "Он встал и подвигал конечностями."
    u"Парень" "чертовщина какая-то!"
